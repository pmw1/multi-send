...
sleep 1
screen -p 0 -S $NAME -X stuff $"set stream opts 0:pid=1000,vbv-maxrate=7300,bitrate=7000,keyint=30,bframes=1,threads=4,format=avc,profile=high,level=5.1,aspect-ratio=16:9,intra-refresh=1\012"
